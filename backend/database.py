            ...
            "interactive_examples": [
                {
                    ...
                    "problem_en": "x - 8 > 2",
                    "problem_ar": "س - ٨ > ٢",
                    "solution_en": "Step 1: Add 8 to both sides to isolate x\nx - 8 + 8 > 2 + 8\nStep 2: Simplify both sides\nx > 10",
                    "solution_ar": "الخطوة ١: أضف ٨ إلى كلا الطرفين لعزل س\nس - ٨ + ٨ > ٢ + ٨\nالخطوة ٢: بسّط كلا الطرفين\nس > ١٠",
                ...
                },
                {
                    ...
                    "problem_en": "12 ≤ k + 3",
                    "problem_ar": "١٢ ≤ ك + ٣",
                    "solution_en": "Step 1: Subtract 3 from both sides to isolate k\n12 - 3 ≤ k + 3 - 3\nStep 2: Simplify both sides\n9 ≤ k",
                    "solution_ar": "الخطوة ١: اطرح ٣ من كلا الطرفين لعزل ك\n١٢ - ٣ ≤ ك + ٣ - ٣\nالخطوة ٢: بسّط كلا الطرفين\n٩ ≤ ك",
                ...
                },
                {
                    ...
                    "solution_en": "Step 1: Subtract 2n from both sides to collect variable terms\n3n - 2n + 6 ≥ 2n - 2n + 9\nStep 2: Simplify to get n + 6 ≥ 9\nStep 3: Subtract 6 from both sides to isolate n\nn ≥ 3",
                    "solution_ar": "الخطوة ١: اطرح ٢ن من كلا الطرفين لتجميع حدود المتغير\n٣ن - ٢ن + ٦ ≥ ٢ن - ٢ن + ٩\nالخطوة ٢: بسّط للحصول على ن + ٦ ≥ ٩\nالخطوة ٣: اطرح ٦ من كلا الطرفين لعزل ن\nن ≥ ٣",
