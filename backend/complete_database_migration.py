...
MONGO_URL = "mongodb+srv://kamalaljallad_db_user:8rKfqDL1OVmtXxvd@cluster0.dip2jyt.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"  # Replace with your production MongoDB URL
